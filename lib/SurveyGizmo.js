...
class SurveyGizmo {
  ...
  buildQuery(responseId = null) {
    ...
    return {
      questionsQuery: `${sgUrl}/${sgSurveyId}/surveyquestion?api_token=${this.apiKey}`,
      responsesQuery: `${sgUrl}/${sgSurveyId}/surveyresponse/${responseId || ''}?api_token=${this.apiKey}&filter[field][1]=status&filter[operator][1]==&filter[value][1]=Complete`,
    };
  }
}
