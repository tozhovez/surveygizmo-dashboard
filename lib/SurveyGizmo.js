...
class SurveyGizmo {
   ...
   */
  getResponses() {
    console.log(`${config.baseUrl}:${config.applicationPort}/surveyresponse.json`);
    return new Promise((resolve, reject) => {
      var url = apiKey ? `${sgUrl}/${sgSurveyId}/surveyresponse?api_token=${apiKey}` : `${config.baseUrl}:${config.applicationPort}/surveyresponse.json`;
  ...
  getQuestions() {
    return new Promise((resolve, reject) => {
      if(this._questions) {
        ...
        var url = apiKey ? `${sgUrl}/${sgSurveyId}/surveyquestion?api_token=${apiKey}` : `${config.baseUrl}:${config.applicationPort}/surveyquestion.json`;
