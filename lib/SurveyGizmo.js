...
class SurveyGizmo {
  ...
  getResponses() {
    return new Promise((resolve, reject) => {
      var url = apiKey ? `https://restapi.surveygizmo.com/v4/survey/3392617/surveyresponse?api_token=${apiKey}` : 'http://localhost:3000/surveyresponse.json';
  ...
  getQuestions() {
    ...
    return new Promise((resolve, reject) => {
      if(this._questions) {
        ...
        var url = apiKey ? `https://restapi.surveygizmo.com/v4/survey/3392617/surveyquestion?api_token=${apiKey}` : 'http://localhost:3000/surveyquestion.json';
